    ...
    <div className="pointer-events-none fixed inset-0 z-20">
      <motion.div
        ...
        style={{
          ...
          translateY: '-50%',
          background:
            'radial-gradient(circle at center, hsla(340, 75%, 55%, 0.4) 0%, hsla(210, 100%, 66%, 0.4) 35%, transparent 80%)',
          filter: 'blur(24px)', 
        }}
        transition={{
          type: 'spring',
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(to right, rgba(255, 229, 100, 0.1) 1px, transparent 1px), linear-gradient(to bottom, rgba(255, 229, 100, 0.1) 1px, transparent 1px)',
